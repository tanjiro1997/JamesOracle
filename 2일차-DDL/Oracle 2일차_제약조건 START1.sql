...
-- PRIMARY KEY : 중복도 안되고 NULL도 안됨, 유일한 값
...
CREATE TABLE SHOP_MEMBER(
    ...
    MEMBER_GENDER VARCHAR2(10) CHECK(MEMBER_GENDER IN ('M', 'F')),
...
DELETE FROM SHOP_MEMBER WHERE MEMBER_ID = 'khuser01';
COMMIT;

CREATE TABLE SHOP_BUY(
    BUY_NUM NUMBER PRIMARY KEY,
    BUY_ID VARCHAR2(20) REFERENCES SHOP_MEMBER(MEMBER_ID) ON DELETE SET NULL, -- 모조리 지우는건 CASCADE
    BUY_NAME VARCHAR2(50),
    BUY_DATE DATE DEFAULT SYSDATE
);
DROP TABLE SHOP_BUY;
-- SHOP_BUY의 BUY_ID는 SHOP_MEMBER의 MEMBER_ID가 가지고 있는 khuser01, khuser02만 넣을 수 있어요
